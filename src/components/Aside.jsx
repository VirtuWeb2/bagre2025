      ...
      >
        <div className="flex gap-[1rem] items-center text-red-700">
          ...
          <h3 className="text-[3rem] font-semibold leading-[1.115]  mb-[1.2rem]">
            Mantenha-se navegando
          </h3>
        </div>
        
          <a
          href="https://www.facebook.com/enoticiabagre?locale=pt_BR"
          target="_blank"
        ...
        >
          ...
          <a
          href="https://www.facebook.com/enoticiabagre/groups?locale=pt_BR"
          target="_blank"
          className="bg-blue-900  flex gap-[1rem] text-[1.6rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox facebook"
        >
          <svg
        ...
        <a
          ...
          target="_blank"
          className="bg-blue-900 flex gap-[1rem] text-[1.6rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox instagram"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32px"
          ...
          target="_blank"
          className="bg-blue-900  flex gap-[1rem] text-[1.6rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox twitter"
        >
<svg 
...
>
   <path d="m18.2342,14.1624l8.7424-10.1624h-2.0717l-7.591,8.8238-6.0629-8.8238h-6.9929l9.1684,13.3432-9.1684,10.6568h2.0718l8.0163-9.3183,6.4029,9.3183h6.9929l-9.5083-13.8376h.0005Zm-2.8376,3.2984l-.9289-1.3287L7.0763,5.5596h3.1822l5.9649,8.5323.9289,1.3287,7.7536,11.0907h-3.1822l-6.3272-9.05v-.0005Z"/>
        ...
        <a
          href="https://www.instagram.com/channel/AbYVEGSIgpyowZ2Q/"
          target="_blank"
          className="bg-blue-900 flex gap-[1rem] text-[1.6rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox instagram"
        >
          <svg
          ...
          Entre em nosso canal do instagram
        </a>
          
          <a
          href="https://www.tiktok.com/@enoticia_pa?_t=ZM-8yn8L61WyBE&_r=1"
          target="_blank"
          className="bg-blue-900 flex gap-[1rem] text-[1.6rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox whatsapp"
          >
          ...
          <a
          href="https://www.youtube.com/@enoticiapara-enpa"
          target="_blank"
          className="bg-blue-900 flex gap-[1rem] text-[1.6rem] font-semibold p-[1rem] rounded-md items-center text-white mt-[1rem] socBox youtube"
          >
